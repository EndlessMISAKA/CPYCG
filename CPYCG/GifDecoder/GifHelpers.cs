...
namespace WpfAnimatedGif
{
    ...
    {
        public const int Extension_GifGraphicControl = 0xF9;
        public const int Extension_GifComment = 0xFE;
        public const int Extension_GifPlainText = 0x01;
        public const int Extension_GifApplication = 0xFF;
